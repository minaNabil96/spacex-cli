...
def list_rockets(
    ...
    if state.output == OutputFormat.TABLE:
        ...
        out_console.print(
            format_json([asdict(r) for r in rockets], pretty=(state.output == OutputFormat.JSON_PRETTY))
        )
...
def rocket_info(
    ...
    if state.output == OutputFormat.TABLE:
        ...
        out_console.print(format_json(asdict(rocket), pretty=(state.output == OutputFormat.JSON_PRETTY)))
